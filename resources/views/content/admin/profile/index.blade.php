  ...
  <div class="col-md-12">
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-2 gap-lg-0">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ Route::has('admin.changePassword') ? route('admin.changePassword') : url('/') }}"><i class='ti-sm ti ti-cloud-lock-open me-1_5'></i> Security</a></li>
