...
<div class="row">
  <div class="col-md-12">
    ...
    {{ html()->model($user)->form('PATCH')->route('admin.profile.update')->class('row g-3')->id('validateForm')->acceptsFiles()->open() }}
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-12">
            ...
            <a href="{{ route('admin.profile') }}" type="button" class="btn btn-label-danger waves-effect">Cancel</a>
          </div>
        </div>
      </div>
    </div>
