...
<div class="row">
  <div class="col-12">
    ...
    <div class="card">
      <h5 class="card-header crud">New User Info</h5>

      <div class="card-body">
        {{ html()->form('POST')->route('admin.users.store')->class('row g-3')->id('validateForm')->open() }}
        <div class="col-md-6">
        ...
        <div class="col-12">
          ...
          auth('admin')->user()->hasPermission(['admin-users-read']))
          <a href="{{ route('admin.users.index') }}" type="button" class="btn btn-label-danger waves-effect">Cancel</a>
          @endif
        </div>
        {{ html()->form()->close() }}
      </div>
