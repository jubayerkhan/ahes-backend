        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              <a class="btn btn-sm btn-icon btn-outline-info waves-effect" href="{{ route('admin.users.show', $user->id) }}"
              ...
              auth('admin')->user()->hasPermission(['admin-users-update']))
              <a class="btn btn-sm btn-icon btn-outline-primary waves-effect"
                href="{{ route('admin.users.edit', $user->id) }}" data-bs-toggle="tooltip" data-bs-placement="top"
              ...
              <a class="btn btn-sm btn-icon btn-outline-warning waves-effect"
                href="{{ route('admin.users.updatePassword', $user->id) }}" data-bs-toggle="tooltip" data-bs-placement="top"
              ...
              @if(auth('admin')->user()->hasRole('admin') ||
              auth('admin')->user()->hasPermission(['admin-users-delete']))
              ...
              {{ html()->form('DELETE')->route('admin.users.destroy',$user->id)->id('deleteForm'.$user->id)->open() }}
              {{ html()->form()->close() }}
              @endif
            </td>
            <td>{{ $user->id }}</td>
