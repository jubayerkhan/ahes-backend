...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Admins /</span> Edit Password
</h4>
  ...
  <div class="col-md-12">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        {{ html()->model($admin)->form('PATCH')->route('admin.admins.updatePasswordStore', $admin->id)->id('formAccountSettings')->open() }}
        <div class="row">
          <div class="col-md-6">
