...
<h4 class="fw-bold py-3 mb-1">
  <span class="text-muted fw-light">Admins /</span> Admin Edit
</h4>
...
<div class="row">
  <div class="col-12">
    ...
    <div class="card">
      <h5 class="card-header crud">Edit Admin Info</h5>

      <div class="card-body">
        {{ html()->model($admin)->form('PATCH')->route('admin.admins.update', $admin->id)->class('row g-3')->id('validateForm')->open() }}
        <div class="col-md-6">
