...
@section('content')
  <h4 class="fw-bold py-3 mb-1">
    <span class="text-muted fw-light">Testimonials /</span> New Testimonial
  </h4>
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          {{ html()->form('POST')->route('admin.testimonials.store')->acceptsFiles()->id('validateForm')->open() }}
          ...
          <div class="col-md-6">
            ...
            <div class="form-group mb-3">
              ...
              {{ html()->text('university')->class('form-control') }}
            </div>
          ...
          <div class="col-12">
            ...
            <a href="{{ route('admin.testimonials.index') }}" class="btn btn-label-danger">Cancel</a>
          </div>
