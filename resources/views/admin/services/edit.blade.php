...
@section('content')
  <h4 class="fw-bold py-3 mb-1">
    <span class="text-muted fw-light">Services /</span> Service Edit
  </h4>
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        <h5 class="card-header crud">Edit Service Info</h5>

        <div class="card-body">
          {{ html()->model($service)->form('PATCH')->route('admin.services.update', $service->id)->class('row g-3')->id('validateForm')->attribute('enctype', 'multipart/form-data')->open() }}
          <div class="col-md-6">
          ...
          <div class="form-check form-check-primary mt-4">
            {{ html()->checkbox('is_feature', null, '1')->class('form-check-input') }}
            {{ html()->label('&nbsp;Add to home page slider', 'feature')->class('form-check-label') }}
          </div>
          ...
          <div class="col-12">
            ...
            @if(
              ...
              <a href="{{ route('admin.services.index') }}" type="button" class="btn btn-label-danger waves-effect">Cancel</a>
            @endif
          </div>
          {{ html()->form()->close() }}
        </div>
