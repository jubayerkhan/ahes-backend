  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          {{ html()->model($point)->form('PATCH')->route('admin.why-points.update', $point->id)->class('row g-3')->id('validateForm')->attribute('enctype', 'multipart/form-data')->open() }}
          <div class="col-md-6">
          ...
          <div class="col-12">
            ...
            @if(
              ...
              <a href="{{ route('admin.why-points.index') }}" type="button" class="btn btn-label-danger waves-effect">Cancel</a>
            @endif
          </div>
          {{ html()->form()->close() }}
        </div>
