              ...
              <div class="dropdown-shortcuts-list scrollable-container">
                <div class="row row-bordered overflow-visible g-0">
                  ...
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="{{route('admin.invoice-preview')}}" class="stretched-link">Invoice Preview</a>
                    <small>Preview Invoice</small>
                  </div>
                </div>
                <div class="row row-bordered overflow-visible g-0">
                  <div class="dropdown-shortcuts-item col">
            ...
            <ul class="dropdown-menu dropdown-menu-end p-0">
              ...
              <li class="border-top">
                <div class="d-grid p-4">
                  <a class="btn btn-primary btn-lg d-flex" href="javascript:void(0);">
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <!-- Auth::user()->image ? asset(Helper::storagePath(Auth::user()->image)) : -->
                <img src="{{ asset('assets/img/avatars/default.png') }}" alt class="rounded-circle">
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end mt-0">
              <li>
                <a class="dropdown-item mt-0" href="{{ Route::has('admin.profile') ? route('admin.profile') : url('/') }}">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <small class="text-muted">{{Auth::user()->role->display_name ?? 'Guest'}}</small>
                    </div>
                  </div>
                </a>
              </li>
              ...
              <li>
                <a class="dropdown-item" href="{{ Route::has('admin.profile') ? route('admin.profile') : url('/') }}">
                  <i class="ti ti-user me-2 ti-md"></i><span class="align-middle">My Profile</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="{{ Route::has('admin.changePassword') ? route('admin.changePassword') : url('/') }}">
                  <i class="ti ti-lock-open me-2 ti-md"></i><span class="align-middle">Change Password</span>
                </a>
              </li>
              ...
              @if (Auth::check())
                <li>
                  <div class="d-grid px-2 pt-2 pb-1">
                    <a class="btn btn-danger d-flex btn-lg" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                      <small class="align-middle fs-6">Logout</small>
                      <i class="ti ti-logout ms-2 ti-16px"></i>
                    </a>
                  </div>
                </li>
              ...
              @else
                <li>
                  <div class="d-grid px-2 pt-2 pb-1">
                    <a class="btn btn-danger d-flex" href="{{ Route::has('admin.login') ? route('admin.login') : url('/') }}">
