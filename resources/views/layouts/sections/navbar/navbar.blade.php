              ...
              <div class="dropdown-shortcuts-list scrollable-container">
                <div class="row row-bordered overflow-visible g-0">
                  ...
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="{{route('invoice-preview')}}" class="stretched-link">Invoice Preview</a>
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <img src="{{ Auth::user()->image ? asset(Helper::storagePath(Auth::user()->image)) : asset('assets/img/avatars/default.png') }}" alt class="rounded-circle">
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end mt-0">
              <li>
                <a class="dropdown-item mt-0" href="{{ Route::has('profile') ? route('profile') : url('/') }}">
              ...
              <li>
                <a class="dropdown-item" href="{{ Route::has('profile') ? route('profile') : url('/') }}">
                  <i class="ti ti-user me-2 ti-md"></i><span class="align-middle">My Profile</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="{{ Route::has('changePassword') ? route('changePassword') : url('/') }}">
              ...
              @if (Auth::check())
                <li>
                  <div class="d-grid px-2 pt-2 pb-1">
                    <a class="btn btn-danger d-flex btn-lg" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
              ...
              @else
                <li>
                  <div class="d-grid px-2 pt-2 pb-1">
                    <a class="btn btn-danger d-flex" href="{{ Route::has('login') ? route('login') : url('/') }}">
