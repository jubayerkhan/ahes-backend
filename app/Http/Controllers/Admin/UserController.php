...
class UserController extends Controller
{
  ...
  {
    if (Auth::guard('admin')->user()->hasRole('admin') || Auth::guard('admin')->user()->hasPermission(['admin-users-create'])) {
  ...
  {
    if (Auth::guard('admin')->user()->hasRole('admin') || Auth::guard('admin')->user()->hasPermission(['admin-users-delete'])) {
      $user = User::findOrFail($id);
  ...
  public function updatePassword($id)
  {
    if (Auth::guard('admin')->user()->hasRole('admin') || Auth::guard('admin')->user()->hasPermission(['admin-users-update'])) {
      $user = User::findOrFail($id);
      return view('content.admin.users.updatePassword', compact('user'));
    } else {
      return view('error.admin-unauthorized');
    }
  }
